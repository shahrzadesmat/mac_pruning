...
python3 mac_pruning_test/main.py \
    ...
    --macs_overshoot_tolerance_pct 0.1 \
    --macs_undershoot_tolerance_pct 11.56 \
    --dataset "$DATASET" \
    ...
    --wandb_name "${MODEL_NAME}_${DATASET}_ratio${RATIO/./p}_job${SLURM_JOB_ID}" \
    --wandb_mode offline
